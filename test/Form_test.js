...
for (let formExtraProps of formExtraPropsList) {
  const createFormComponent = props =>
    createFormComponentFn({ ...props, ...formExtraProps });
  describe("Form common " + JSON.stringify(formExtraProps), () => {
    let sandbox;
    ...
    describe("Empty schema", () => {
      ...
      it("should render a submit button", () => {
        ...
        expect(node.querySelectorAll("button[type=submit]")).to.have.length.of(
          1
        );
      });

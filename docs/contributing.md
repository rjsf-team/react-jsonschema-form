...
You can also publish the latest release of the docs by running the [Release Latest Documentation](https://github.com/rjsf-team/react-jsonschema-form/actions/workflows/release-docs.yml) workflow.

...
## Forms do not enable HTML5 validation by default

In v3.x, the `noHTML5Validate` property has been removed and replaced with `html5Validate`, which has a default value of false. Seem more about [this change here](https://github.com/rjsf-team/react-jsonschema-form/issues/1184).

...
import MaterialUIContextProps, { defaultMaterialUIContext } from '../Theme/MaterialUIContextProps';
 ...
 */
export default React.createContext<MaterialUIContextProps | Mui5ContextProps>(defaultMaterialUIContext);

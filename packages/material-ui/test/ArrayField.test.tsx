...
describe("ArrayField", () => {
  ...
  describe("List of inputs", () => {
    ...
    it.only("should render a fieldset", () => {
      const { node } = createFormComponent({ schema });

      const fieldset = node.querySelectorAll("fieldset");
      console.error(node.innerHTML);
    ...
    it("should render a fieldset legend", () => {
      ...
      const legend = node.querySelector(".field-array > legend")!;
    ...
    it("should render a description", () => {
      ...
      const description = node.querySelector(".field-array > .field-description")!;
    ...
    it("should mark a non-null array item widget as required", () => {
      ...
      expect(node.querySelector<HTMLInputElement>(".field-string input[type=text]")!.required).eql(
        true
      );
    });
    ...
    it("should fill an array field with data", () => {
      ...
      const inputs: NodeListOf<HTMLInputElement> = node.querySelectorAll(".field-string input[type=text]");
    ...
    it("should disable move buttons on the ends of the list", () => {
      ...
      const moveUpBtns = node.querySelectorAll<HTMLButtonElement>(".array-item-move-up");
      const moveDownBtns = node.querySelectorAll<HTMLButtonElement>(".array-item-move-down");
    ...
    it("should delete item from list and correct indices", () => {
      ...
      Simulate.change(inputs[0], { target: { value: "fuzz" } as HTMLInputElement });
    ...
    it("should handle cleared field values in the array", () => {
      ...
      Simulate.change(node.querySelector<HTMLInputElement>("#root_1")!, {
    ...
    it("should render enough inputs with proper defaults to match minItems in schema when no formData is set", () => {
      ...
      let inputs: NodeListOf<HTMLInputElement> = form.node.querySelectorAll("input[type=text]");
  ...
  describe("Nested lists", () => {
    ...
    it("should render two lists of inputs inside of a list", () => {
      ...
      expect(node.querySelectorAll(".field-array fieldset")).to.have.lengthOf(2);
    });

    it("should add an inner list when clicking the add button", () => {
      const { node } = createFormComponent({ schema });
      expect(node.querySelectorAll(".field-array fieldset")).to.be.empty;

      Simulate.click(node.querySelector(".array-item-add button")!);

      expect(node.querySelectorAll(".field-array fieldset")).to.have.lengthOf(1);
    });
  ...
  describe("Fixed items lists", () => {
    ...
    it("should render a fieldset", () => {
      ...
      expect(node.querySelectorAll(".field-array")).to.have.lengthOf(1);
    });
    ...
    it("should render field widgets", () => {
      ...
      const strInput = node.querySelector(
        ".field-array .field-string input[type=text]"
      );
      const numInput = node.querySelector(
        ".field-array .field-number input[type=number]"
      );
    ...
    it("should apply uiSchema to additionalItems", () => {
      ...
      const label = node.querySelector(
        ".field-array .field-string label.control-label"
      );
  ...
  describe("Title", () => {
    const TitleField = (props: {title: string}) => <div id={`title-${props.title}`} />;

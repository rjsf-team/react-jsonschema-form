...
describe("withTheme", () => {
  ...
  describe("With fields", () => {
    it("should use the withTheme field", () => {
      ...
      expect(node.querySelectorAll(".string-field")).to.have.lengthOf(2);
    });
    ...
    it("should use withTheme field and the user defined field", () => {
      ...
      expect(node.querySelectorAll(".number-field")).to.have.lengthOf(1);
    });
    ...
    it("should use only the user defined field", () => {
      ...
      expect(node.querySelectorAll(".string-field")).to.have.lengthOf(0);
      expect(node.querySelectorAll(".form-control")).to.have.lengthOf(2);
    });
  });
  ...
  describe("With widgets", () => {
    it("should use the withTheme widget", () => {
      ...
      expect(node.querySelectorAll("#test")).to.have.lengthOf(1);
    });
    ...
    it("should use the withTheme widget as well as user defined widget", () => {
      ...
      expect(node.querySelectorAll("#test-theme-widget")).to.have.lengthOf(1);
      expect(node.querySelectorAll("#test-user-widget")).to.have.lengthOf(1);
    });
    ...
    it("should use only the user defined widget", () => {
      ...
      expect(node.querySelectorAll("#test-theme-widget")).to.have.lengthOf(0);
      expect(node.querySelectorAll("#test-user-widget")).to.have.lengthOf(1);
    });
  });
  ...
  describe("With templates", () => {
    ...
    it("should use only the user defined template", () => {
      ...
      expect(node.querySelectorAll(".user-field-template")).to.have.lengthOf(
        1
      );
    });

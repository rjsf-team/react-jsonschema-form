import type { RJSFSchema, SchemaUtilsType } from '../../src/index.js';
import { createSchemaUtils, getByPath, getClosestMatchingOption } from '../../src/index.js';
import { calculateIndexScore } from '../../src/schema/getClosestMatchingOption.js';
import {
  oneOfData,
  oneOfSchema,
  ONE_OF_SCHEMA_DATA,

...
/** Represents a segment in the path to a form field */
export interface PathSegment {
  /** Type of the segment - object property or array index */
  type: 'object' | 'array';
...
export type FieldPath = {
  /** The name of a field */
  $name: string;
  /** Path segments for name generation */
...
export type PathSchema<T = any> = FieldPath & {
  /** The schema element at this path */
  [key: string]: PathSchema<T> | string | PathSegment[] | undefined;
};
...
export interface FieldProps<T = any, S extends StrictRJSFSchema = RJSFSchema, F extends FormContextType = any>
  ...
  /** The tree of unique ids for every child field */
  idSchema: IdSchema<T>;
  /** The tree of unique names for every child field */
...
export interface WidgetProps<T = any, S extends StrictRJSFSchema = RJSFSchema, F extends FormContextType = any>
   ...
   */
  name: string;
  /** The HTML name attribute value (separate from id and name) - generated by nameGenerator if provided */
  htmlName?: string;
  /** Path segments for custom name generation in widgets */

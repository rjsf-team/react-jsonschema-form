...
jest.mock('@trussworks/react-uswds', () => {
  ...
  if (mockComponents.Icon) {
    ...
    mockIcon.Add = jest.fn((props) =>
      React.createElement('div', { 'data-testid': 'mock-Icon.Add', ...props }),
    );
    ...
    mockIcon.Delete = jest.fn((props) =>
      React.createElement('div', { 'data-testid': 'mock-Icon.Delete', ...props }),
    );
  }

...
- Rollback `isValid()` in `retrieveSchema()` to `validateFormData()` to prevent a bug with empty enums blocking dependencies. Fixes [#4418](https://github.com/rjsf-team/react-jsonschema-form/pull/4418)

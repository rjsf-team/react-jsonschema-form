...
- Fixed defaults from a dependency subschema being omitted when `getDefaultFormState()` is called without form data or with an empty object ([#5198](https://github.com/rjsf-team/react-jsonschema-form/issues/5198))
